...
namespace ET.SSO.IdentityServer4.Services.Implementation
{
    public class ConsentCustomService : IConsentCustomService
    {
        #region 私有变量
        ...
        //针对ApiResource，一个ApiResource有多个Scope
